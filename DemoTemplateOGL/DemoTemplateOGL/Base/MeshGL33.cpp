...
// constructor
MeshGL33::MeshGL33(vector<Vertex>& vertices, vector<unsigned int>& indices, vector<Texture>& textures, vector<Material>& materials, int VBOGLDrawType, int EBOGLDrawType, int TYPEGLDrawType){
...
MeshGL33::MeshGL33(vector<Vertex>& vertices, vector<unsigned int>& indices, vector<Texture>& textures, int VBOGLDrawType, int EBOGLDrawType, int TYPEGLDrawType) {
    this->vertices = vertices;
    this->indices = indices;
    this->textures = textures;
    this->VBOGLDrawType = VBOGLDrawType;
