...
public:
        ...
        : Billboard(0, (WCHAR*)L"Lluvia", 0, 0, 0, camDetails)
    {
        ...
        meshes.push_back(Mesh::createMesh(gotas, indices, textures, GL_DYNAMIC_DRAW, GL_DYNAMIC_DRAW, GL_LINES));
    }
    ...
    void Draw(){
        if (gpuDemo == NULL){
            gpuDemo = Shader::createShader("shaders/lluvia.vs", "shaders/lluvia.fs");
        }
        Draw(*gpuDemo);
    }
    ...
    void Draw(Shader& shader) {
        ...
        shader.setVec3("color", glm::vec3(0.5f, 0.5f, 1.0f));
