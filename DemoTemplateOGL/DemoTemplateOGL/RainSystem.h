...
public:
    ...
    Splash(WCHAR* textura, int maxDrops, Camera *cameraDetails);
...
public:
    ...
    RainDrop(WCHAR* textura, int maxDrops, int areaSize, int height, Camera *cameraDetails);
